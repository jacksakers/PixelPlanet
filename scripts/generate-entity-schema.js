...
// ─── fallback constants (kept up to date at Phase 3.6+) ────────────────────────
const FALLBACK = {
  CONDITION_TYPES: [
  ...
  SPRITE_RESOLUTIONS: ['3×3', '5×5', '8×8', '10×10', '16×16', '32×32'],
  DIRECTIONS: [
    'up', 'down', 'left', 'right',
...
**Resolution presets:** ${FALLBACK.SPRITE_RESOLUTIONS.join(', ')}.
