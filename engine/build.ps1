...
$emccArgs = @(
    ...
    "-sEXPORTED_FUNCTIONS=_engine_init,_engine_get_cells,_engine_set_pixel,_engine_update,_engine_load_config,_engine_set_seed,_engine_send_click,_engine_set_button_state,_engine_get_score,_engine_get_game_state,_engine_reset_game",
